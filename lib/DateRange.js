...
var DateRange = (function (_Component) {
  ...
  function DateRange(props, context) {
    ...
    var rangeKeys = ['startDate', 'endDate'];
  ...
  _createClass(DateRange, [{
    ...
    key: 'dateLimit',
    value: function dateLimit(range) {
    ...
    value: function handleSelect(date, source) {
      var key = this.rangeKeys.indexOf(this.state.forceEdit);
...
DateRange.defaultProps = {
  ...
  calendars: 2,
  onlyClasses: false,
  dateLimit: function dateLimit(range) {
    return range;
  },
  classNames: {}
};
...
DateRange.propTypes = {
  ...
  forceEdit: _react.PropTypes.string
};
